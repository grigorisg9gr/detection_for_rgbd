...
mxArray *process(const mxArray *mximage, const mxArray *mxsbin) {
  ...
  // Iterate through all pixels with replication at border
...
% Look at behaviour of first 8 pixels
...
%If we want to use 8x8 gradients for topleft cell, we should use:
xp  = (x-0.5)/sbin - .5;
ixp = floor(xp);
vx0 = xp - ixp;
vx1 = 1 - vx0;
