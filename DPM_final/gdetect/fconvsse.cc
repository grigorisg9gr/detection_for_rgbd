    ...
    for (int y = 0; y < C_dims[0]; y++) {
      ...
      for (int xp = 0; xp < B_dims[1]; xp++) {
        ...
        for (int yp = 0; yp < B_dims[0]; yp++) {
          ...
          a = _mm_load_ps(A_off+4+32);
          b = _mm_load_ps(B_off+4+32);
          c = _mm_mul_ps(a, b);
          v = _mm_add_ps(v, c);

          a = _mm_load_ps(A_off+8+32);
          b = _mm_load_ps(B_off+8+32);
          c = _mm_mul_ps(a, b);
          v = _mm_add_ps(v, c);

          a = _mm_load_ps(A_off+12+32);
          b = _mm_load_ps(B_off+12+32);
          c = _mm_mul_ps(a, b);
          v = _mm_add_ps(v, c);

          a = _mm_load_ps(A_off+16+32);
          b = _mm_load_ps(B_off+16+32);
          c = _mm_mul_ps(a, b);
          v = _mm_add_ps(v, c);

          a = _mm_load_ps(A_off+20+32);
          b = _mm_load_ps(B_off+20+32);
          c = _mm_mul_ps(a, b);
          v = _mm_add_ps(v, c);

          a = _mm_load_ps(A_off+24+32);
          b = _mm_load_ps(B_off+24+32);
          c = _mm_mul_ps(a, b);
          v = _mm_add_ps(v, c);

          a = _mm_load_ps(A_off+28+32);
          b = _mm_load_ps(B_off+28+32);
          c = _mm_mul_ps(a, b);
          v = _mm_add_ps(v, c);
