...
if nargin < 3
  [~, name] = system('hostname'); note=[datestr(datevec(now()), 'dd.mmm.yyyy:HH.MM.SS') ' computer: ' name] ;
end
...
ap1 = pascal_eval(cls, ds, testset, suffix);
